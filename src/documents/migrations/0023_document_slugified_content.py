...
class Migration(migrations.Migration):
    ...
    def casefold_forwards(apps, schema_editor):
        ...
        for doc in Document.objects.all():
            if doc.title is not None:
                doc.slugified_title = slugifyOCR(doc.title)
            if doc.content is not None:
                doc.slugified_content = slugifyOCR(doc.content)
            doc.save()
    ...
    def database_backwards(self, app_label, schema_editor, from_state, to_state):
        migrations.RemoveField(model_name="document", name="slugified_content"),
        migrations.RemoveField(model_name="document", name="slugified_title"),

    operations = [
        migrations.AddField(
            model_name="document",
            name="slugified_content",
