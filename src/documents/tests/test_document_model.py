...
class TestDocument(TestCase):
    ...
    def test_sulgified_title_and_content(self):
        ...
        self.assertEqual(document.slugified_title, "title")
        self.assertEqual(document.slugified_content, "content")
        ...
        self.assertEqual(document.slugified_title, "zurich weiss")
        self.assertEqual(document.slugified_content, "telefonica eee aaa")


        document = Document.objects.create(checksum="azerty3")
        self.assertEqual(document.title, '')
        self.assertEqual(document.content, '')
        self.assertEqual(document.slugified_title, '')
        self.assertEqual(document.slugified_content, '')
